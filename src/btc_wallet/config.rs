...
use bitcoin_wallet::{spending_path::{tap_script_spending_ex::{output_factory, input_factory}, create_tx}, input_data::{tapscript_ex_input::TapscriptExInput, electrum_rpc::ElectrumCall}, script_services::api::create_partially_signed_tx};

use either::Either;
use miniscript::ToPublicKey;
use wallet_test::{tapscript_example_with_tap::Test, wallet_test_vector_traits::WalletTestVectors};

use crate::bitcoin_wallet::{address_formats::{p2tr_addr_fmt::P2TR, AddressSchema}, input_data::{tapscript_ex_input::get_signed_tx, reuse_rpc_call::ReUseCall}, spending_path::{mutlisig_path::MultiSigPath, p2tr_key_path::P2TRVault, vault_adaptor::VaultAdapter}, wallet_methods::{ClientWithSchema, BroadcastOp}};
