use bitcoin::{Address, util::bip32::ExtendedPubKey, Transaction, psbt::Input, Script, Txid};
use electrum_client::{ListUnspentRes, Error, GetBalanceRes};

use super::{ClientWallet, Broadcast_op, SignTx};
...
pub trait AddressSchema{
    ...
    fn prv_tx_input(&self,previous_tx:Vec<Transaction>,current_input:Transaction,signing_fn:&dyn Fn(SignTx)->(Input)) ->Vec<Input>;
}
